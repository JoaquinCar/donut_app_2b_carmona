...
import 'package:donut_app_2b_carmona/models/category.dart';
import 'package:donut_app_2b_carmona/services/product_service.dart';
  ...
  Future<void> loadProducts({int? categoryId}) async {
    ...
    try {
      final fetchedProducts = categoryId == null
          ...
          : await ProductService.getProductByCategory(categoryId);
      setState(() {
